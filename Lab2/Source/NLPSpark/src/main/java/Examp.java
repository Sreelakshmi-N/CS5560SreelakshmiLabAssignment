...
public class Examp {
    ...
    public static void main(String[] args) { Set personSet = new HashSet();
        ...
        SparkConf conf = new SparkConf().setAppName("Samp").setMaster("local[*]");
...
//    pairRDD.mapToPair(tuple -> tuple);
        ...
        while(sc1.hasNext()) {
            ...
            if(sc1.nextLine()=="Who was the 44th President?");
            System.out.println("Barak Obama");
            if(sc1.nextLine()=="Where Barak Obama born?");
