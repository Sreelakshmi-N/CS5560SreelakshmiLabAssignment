    ...
    public String lemmatize(String documentText)
    {
        ...
        for(CoreMap sentence: sentences) {
            ...
            for (CoreLabel token: sentence.get(TokensAnnotation.class)) {
                ...
                word.add(token.get(CoreAnnotations.TextAnnotation.class));
                System.out.println(word);
                pos.add(token.get(CoreAnnotations.PartOfSpeechAnnotation.class));
                System.out.println(pos);
                ne.add(token.get(CoreAnnotations.NamedEntityTagAnnotation.class));
        ...
        //String k = sb.toString() + word + pos + ne;
        System.out.println(word);
        System.out.println(pos);
        System.out.println(ne);
        return sb.toString();
